...
import 'package:ui_sdk/components/UikButton.dart';
...
class WidgetCompactList extends StatelessWidget {
   WidgetCompactList({
    super.key,
    required this.globalWidgetResponse, dynamic this.onComponentAdded
  });
  String globalWidgetResponse;
   ...
   addComponent( ){
     ApiResponse globalResponseParsed = ApiResponse.fromJson(jsonDecode(globalWidgetResponse));
     StandardScreenResponse standardScreenResponse =  StandardScreenResponse.fromJson(
         globalResponseParsed.data);
     var randomId = Random().nextInt(1000).toString();
     standardScreenResponse.widgets.add(StandardPageResponseWidgets(randomId,WidgetType.UikButton.toString()));
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        if(index < standardScreenResponse.widgets.length){
          final StandardPageResponseWidgets item = standardScreenResponse.widgets[index];
          return ListTile(
